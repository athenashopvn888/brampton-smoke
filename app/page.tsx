...
const LOCAL_FAQS = [
  {
    q: "What are the hours for Brampton Smoke Cannabis?",
    a: "Brampton Smoke Cannabis at 132 Falby Rd Unit B, Brampton is Open 24 Hours a day, 7 days a week. Walk in anytime — no appointment needed.",
  },
  {
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.brandBlock}>
            ...
            <h1 className={styles.brandTitle}>BRAMPTON SMOKE CANNABIS</h1>
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            <h2 className={styles.seoPanelTitle}>Falby Rd & Steeles Ave E's Premier Cannabis Dispensary — Open 24 Hours</h2>
            <p className={styles.seoPanelText}>
              Welcome to <strong>Brampton Smoke Cannabis</strong>, Brampton's premier 24-hour cannabis destination at 132 Falby Rd Unit B. We carry an electrifying selection of top-shelf strains around the clock — from ultra-rare exotics to solid everyday budget picks.
            </p>
            <p className={styles.seoPanelText}>
              Open 24 hours, 7 days a week — Brampton Smoke Cannabis never closes. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down after a late shift or stocking up for the weekend, our knowledgeable staff can help during listed store hours.
            </p>
            <p className={styles.seoPanelText}>
              Searching for a cannabis dispensary in Brampton or the surrounding area? Brampton Smoke Cannabis is your 24-hour destination for premium flower, potent prerolls, and artisan edibles. Our six-tier pricing system means quality cannabis at every budget level — starting from just $3/g.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className={styles.storeGrid}>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                ...
                <br />
                <span className={styles.storeHighlight}>Falby Rd & Steeles Ave E, Brampton</span>
              </p>
            </div>
          </div>
