...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("BSC01_age_verified");
    if (verified !== "true") {
  ...
  const handleVerify = () => {
    localStorage.setItem("BSC01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              ...
              <img
                ...
                alt="Brampton Smoke Cannabis"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              Brampton Smoke Cannabis requires all visitors to be of legal age.
