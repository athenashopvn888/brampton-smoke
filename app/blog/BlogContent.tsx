...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Brampton Smoke Cannabis is Brampton's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=BSC01`)
      .then((r) => r.json())
    ...
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          ...
          alt="Brampton Smoke Cannabis Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Brampton Smoke Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
