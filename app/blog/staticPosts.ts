...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Brampton Smoke Cannabis Visit Without Guessing",
    "seoTitle": "Brampton Smoke Cannabis Visit Guide | Weed Dispensary in Brampton",
    "seo_title": "Brampton Smoke Cannabis Visit Guide | Weed Dispensary in Brampton",
    "metaDescription": "Plan a Brampton visit to Brampton Smoke Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Brampton visit to Brampton Smoke Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Brampton Smoke Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for Brampton Smoke Cannabis, written for shoppers who want the next step without the runaround.",
    "author": "Ravi North",
  ...
  },
  {
    ...
    "seoTitle": "Brampton Smoke Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Brampton Smoke Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Brampton Smoke Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Brampton Smoke Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Brampton Smoke Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Brampton Smoke Cannabis.",
    "author": "Nina Smoke",
    "authorName": "Nina Smoke",
    "authorHandle": "@NinaBSC",
    "authorRole": "House Writer",
  ...
  },
  {
    ...
    "seoTitle": "Brampton Smoke Cannabis Menu Guide | Brampton Weed Store",
    "seo_title": "Brampton Smoke Cannabis Menu Guide | Brampton Weed Store",
    "metaDescription": "Shop the Brampton Smoke Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Brampton Smoke Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Brampton Smoke Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Brampton Smoke Cannabis menu without turning the visit into a guessing game.",
    "author": "Ravi North",
    "authorName": "Ravi North",
    "authorHandle": "@RaviBrampton",
    "authorRole": "House Writer",
