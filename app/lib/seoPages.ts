...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "If you searched for a weed dispensary in Brampton or a cannabis dispensary in Brampton, use this page to get oriented. Brampton, Queen Street, Kennedy Road, Bramalea are useful local cues, but the current menu and staff are the right place for details that change."
      },
      {
  ...
  },
  {
    ...
    "icon": ">",
    "heroTagline": "Local visit notes for Brampton, Queen Street, Kennedy Road, Bramalea",
    "sections": [
      {
