...
export const TIER_SEO: Record<string, TierSeoData> = {
  EXOTIC: {
    seoTitle: "Exotic Weed & Cannabis Flower Brampton | Brampton Smoke Cannabis",
  ...
  PREMIUM: {
    seoTitle: "Premium Weed & Cannabis Flower Brampton | Brampton Smoke Cannabis",
  ...
  "AAA+": {
    seoTitle: "AAA+ Weed & Cannabis Flower Brampton | Brampton Smoke Cannabis",
  ...
  AA: {
    seoTitle: "AA Weed & Cannabis Flower Brampton | Brampton Smoke Cannabis",
  ...
  BUDGET: {
    seoTitle: "Budget Weed & Cannabis Flower Brampton | Brampton Smoke Cannabis",
