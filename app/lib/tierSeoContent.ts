...
export const TIER_SEO: Record<string, TierSeoData> = {
  EXOTIC: {
    seoTitle: "Weed Exotic & Cannabis Flower Brampton | Brampton Smoke Cannabis",
    ...
    socialTitle: "Weed Exotic & Cannabis Flower in Brampton",
    ...
    h1: "Weed Exotic & Cannabis Flower in Brampton",
    imageAlt: "Exotic weed and cannabis flower in Brampton",
    strainHeading: "Explore Weed Exotic Strains",
  ...
  PREMIUM: {
    seoTitle: "Weed Premium & Cannabis Flower Brampton | Brampton Smoke Cannabis",
    ...
    socialTitle: "Weed Premium & Cannabis Flower in Brampton",
    ...
    h1: "Weed Premium & Cannabis Flower in Brampton",
    imageAlt: "Premium weed and cannabis flower in Brampton",
    strainHeading: "Explore Weed Premium Strains",
  ...
  "AAA+": {
    seoTitle: "Weed AAA+ & Cannabis Flower Brampton | Brampton Smoke Cannabis",
    ...
    socialTitle: "Weed AAA+ & Cannabis Flower in Brampton",
    ...
    h1: "Weed AAA+ & Cannabis Flower in Brampton",
    imageAlt: "AAA+ weed and cannabis flower in Brampton",
    strainHeading: "Explore Weed AAA+ Strains",
  ...
  AA: {
    seoTitle: "Weed AA & Cannabis Flower Brampton | Brampton Smoke Cannabis",
    ...
    socialTitle: "Weed AA & Cannabis Flower in Brampton",
    ...
    h1: "Weed AA & Cannabis Flower in Brampton",
    imageAlt: "AA weed and cannabis flower in Brampton",
    strainHeading: "Explore Weed AA Strains",
  ...
  BUDGET: {
    seoTitle: "Weed Budget & Cannabis Flower Brampton | Brampton Smoke Cannabis",
    ...
    socialTitle: "Weed Budget & Cannabis Flower in Brampton",
    ...
    h1: "Weed Budget & Cannabis Flower in Brampton",
    imageAlt: "Budget weed and cannabis flower in Brampton",
    strainHeading: "Explore Weed Budget Strains",
